        ...
        <div className="min-h-screen bg-[#f0f9ff] text-gray-900 font-dm">
            ...
            <div className="relative h-64 w-full">
                ...
                <div className="absolute inset-0 flex flex-col justify-end px-10 pb-8">
                    ...
                    <h1 className="font-playfair text-white text-4xl font-bold">{booking.name}</h1>
                </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto px-6 py-12">
                ...
                {/* Package Info Strip */}
                <div className="flex items-center justify-between bg-white rounded-2xl px-6 py-4 shadow-sm mb-10 border border-cyan-100">
                ...
                <div className="mb-10">
                    <h2 className="font-playfair text-2xl font-semibold mb-1 text-gray-800">Select Departure Date</h2>
                    <p className="text-gray-400 text-sm mb-5">Pick from available departure slots</p>
                ...
                {/* Travelers */}
                <div className="mb-10">
                    <h2 className="font-playfair text-2xl font-semibold mb-5 text-gray-800">Number of Travelers</h2>
                ...
                {/* Total + Book */}
                <div className="bg-white rounded-2xl border border-cyan-100 shadow-sm px-8 py-6 flex items-center justify-between">
                    <div>
                        <p className="text-gray-400 text-xs uppercase tracking-widest mb-1">Total Amount</p>
                        <p className="font-playfair text-3xl font-bold text-cyan-600">₹{totalPrice.toLocaleString()}</p>
                    ...
                    <div className="text-right">
                        ...
                        <button
                            onClick={createOrder}
                            disabled={loading}
                            className="bg-cyan-500 hover:bg-cyan-400 text-white font-semibold text-sm px-10 py-4 rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-md shadow-cyan-200"
                        >
